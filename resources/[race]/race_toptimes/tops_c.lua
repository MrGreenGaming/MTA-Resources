...
function updateTexture()
	...
	for k, r in ipairs(times) do
		...
		if k <= tops then
			...
			if r.country ~= nil and type(r.country) == 'string' and r.country ~= '0' then dxDrawImage(w*flag.x*sw, (titleHeight+(i-0.85)*topsAreaHeight/tops)*sh, 16, 11, ":admin/client/images/flags_new/"..string.lower(r.country)..".png") end
	...
	if monthlyTopTime then
		...
		if monthlyTopTime.country ~= nil and type(monthlyTopTime.country) == 'string' and monthlyTopTime.country ~= '0' then dxDrawImage(w*flag.x*sw, (titleHeight+topsAreaHeight+personalTopHeight+7.6)*sh, 16, 11, ":admin/client/images/flags_new/"..string.lower(monthlyTopTime.country)..".png") end
