...
function onPlayerUseSuperRam()
	...
	setBlurLevel(255)
	local turnvelx, turnvely, turnvelz = getElementAngularVelocity(playerveh)
	...
	setTimer(setElementAngularVelocity, returntopositiontime, 1, playerveh, turnvelx, turnvely, turnvelz)
