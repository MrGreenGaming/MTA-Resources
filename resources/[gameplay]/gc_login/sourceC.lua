...
addEventHandler("onClientResourceStart", resourceRoot, function()
	...
	if screenX < 1280 or screenY < 720 then
		-- Screen is too small, skipping login screen
		outputChatBox("Skipping login screen because your resolution is too small. Minimum required: 1280x720. Please use /gclogin [user] [password] to login")
	else
		showLogin(true)
		fadeCamera(false)
	end
