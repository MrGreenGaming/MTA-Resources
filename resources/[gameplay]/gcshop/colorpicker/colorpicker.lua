...
colorPicker = {
	...
	constructor = function( info )
		...
		guiSetVisible(colorPicker.GUI.alphaBar, false)
		...
		guiSetVisible(colorPicker.children.A, false)
		guiSetVisible(colorPicker.GUI.labelA, false)
	...
	convertColorToTable = function( color )
		...
		local checkValue = function(value)
		                     if not value then return 126 end
