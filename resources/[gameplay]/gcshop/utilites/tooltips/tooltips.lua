...
function drawTooltip(tooltip, alpha)
  ...
  -- corners
  dxDrawImageSection(tooltip.x-16, tooltip.y-16-offset, 16, 16, 0, 0, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  dxDrawImageSection(tooltip.x+tooltip.w, tooltip.y-16-offset, 16, 16, 32, 0, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  dxDrawImageSection(tooltip.x-16, tooltip.y+tooltip.h-offset, 16, 16, 0, 32, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  dxDrawImageSection(tooltip.x+tooltip.w, tooltip.y+tooltip.h-offset, 16, 16, 32, 32, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  -- v-sides
  dxDrawImageSection(tooltip.x, tooltip.y-16-offset, tooltip.w, 16, 16, 0, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  dxDrawImageSection(tooltip.x, tooltip.y+tooltip.h-offset, tooltip.w, 16, 16, 32, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  -- h-sides
  dxDrawImageSection(tooltip.x-16, tooltip.y-offset, 16, tooltip.h, 0, 16, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  dxDrawImageSection(tooltip.x+tooltip.w, tooltip.y-offset, 16, tooltip.h, 32, 16, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  -- center
  dxDrawImageSection(tooltip.x, tooltip.y-offset, tooltip.w, tooltip.h, 16, 16, 16, 16, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  -- arrow
  if tooltip.bottom then
    dxDrawImageSection(tooltip.arrow-16, tooltip.y-24-offset, 32, 24, 0, 48, 32, 24, "/utilites/tooltips/sprite.png", 180, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  else
    dxDrawImageSection(tooltip.arrow-16, tooltip.y+tooltip.h-offset, 32, 24, 0, 48, 32, 24, "/utilites/tooltips/sprite.png", 0, 0, 0, tocolor(tooltip.br,tooltip.bg,tooltip.bb,alpha), true)
  end  
  -- text
