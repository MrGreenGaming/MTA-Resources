...
function build_mainGCShopWindow()
	...
	gui["_root"] = guiCreateStaticImage(left, top, windowWidth, windowHeight, "utilites/img/blank_white.png", false)
	guiSetProperty(gui["_root"], "ImageColours", "tl:FF0A0A0A tr:FF0A0A0A bl:FF0A0A0A br:FF0A0A0A") 
	GUIEditor.staticimage[2] = guiCreateStaticImage(0, 0, 854, 10, "utilites/img/blank_white.png", false, gui["_root"])
	guiSetProperty(GUIEditor.staticimage[2], "ImageColours", "tl:FF4EC857 tr:FF4EC857 bl:FF4EC857 br:FF4EC857")
	GUIEditor.staticimage[3] = guiCreateStaticImage(0, 10, 854, 10, "utilites/img/blank_white.png", false, gui["_root"])
