...
GUIEditor.teamcolour = guiCreateEdit(145, 187, 74, 28, "#000000", false, GUIEditor.tab[1])
...
GUIEditor.teammsg = guiCreateEdit(145, 225, 228, 28, "Welcome!", false, GUIEditor.tab[1])
