...
--  [id]= { ID,     price,         description,               , loading function,     				, expire length in days,		allowed modes filter},
	[1] = { ID = 1, price =  1000, description = 'Bike trials', func = 'loadGCTrials'},
	[2] = { ID = 2, price =  1500, description = 'Faster respawn for 60 days', func = 'loadGCRespawn', exp = 60},
	[3] = { ID = 3, price =  1000, description = 'HP Regen for 30 days', func = 'loadGCRegenHP', exp = 30},
	...
	[6] = { ID = 6, price =  1000, description = 'Longer burnup time', func = 'loadGCBurn', modes = {'Sprint', 'Never the same', 'Shooter', 'Deadline', 'Reach the flag', 'Capture the flag', 'Destruction derby'}},
	[7] = { ID = 7, price =  1250, description = 'Extra long burnup time', func = 'loadGCBurnExtra', requires = {6}, exp = 30, modes = {'Sprint', 'Never the same', 'Shooter', 'Deadline', 'Reach the flag', 'Capture the flag', 'Destruction derby'}},
	[8] = { ID = 8, price =  3000, description = 'Health transfer', func = 'loadGCBurnTransfer', requires = {6}, exp = 30, disabled = true},
	[9] = { ID = 9, price =  1000, description = 'Double sided objects', func = 'loadDoubleSided'},
	[10] = { ID = 10, price =  1000, description = 'Colored Projectiles for 20 days', func = 'loadProjectileColor', exp = 20},
	[11] = { ID = 11, price =  750, description = 'NTS/DD Vehicle reroll for 30 days', func = 'loadVehicleReroll', exp = 30},
