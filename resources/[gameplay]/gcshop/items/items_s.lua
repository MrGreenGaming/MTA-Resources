...
--  [id]= { ID,     price,         description,               , loading function,     				, expire length in days,		allowed modes filter},
	...
	[8] = { ID = 8, price =  3000 / 2, description = 'Health transfer', func = 'loadGCBurnTransfer', requires = {6}, exp = 30, disabled = true},
	[9] = { ID = 9, price =  3000 / 2, description = 'Double sided objects', func = 'loadDoubleSided'},
	[10] = { ID = 10, price =  500 / 2, description = 'Colored Projectiles for 30 days', func = 'loadProjectileColor', exp = 30},
	[11] = { ID = 11, price =  1500 / 2, description = 'NTS/DD Vehicle reroll for 30 days', func = 'loadVehicleReroll', exp = 30},
	[12] = { ID = 12, price =  500 / 2, description = 'Deadline color change', func = 'loadDeadlineColorChange', exp = 30},
