...
rocketColorPicker = {}
rocketColorPicker.__index = rocketColorPicker

function openPicker(id, start, title)
  if id and not pickerTable[id] then
    pickerTable[id] = rocketColorPicker.create(id, start, title)
...
function rocketColorPicker.create(id, start, title)
  local cp = {}
  setmetatable(cp, rocketColorPicker)
  cp.id = id
  cp.color = {}
  ...
  guiBringToFront( cp.gui.window  )
  cp.gui.svmap = guiCreateStaticImage(16, 32, 256, 256, "items/coloredprojectiles/blank.png", false, cp.gui.window)
  cp.gui.hbar = guiCreateStaticImage(288, 32, 32, 256, "items/coloredprojectiles/blank.png", false, cp.gui.window)
  cp.gui.blank = guiCreateStaticImage(336, 32, 64, 64, "items/coloredprojectiles/blank.png", false, cp.gui.window)
...
function rocketColorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "items/coloredprojectiles/sv.png", 0, 0, 0, self.color.white, true)
  dxDrawImage(x+288, y+32, 32, 256, "items/coloredprojectiles/h.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "items/coloredprojectiles/cursor.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "items/coloredprojectiles/cursor.png", 0, 0, 0, self.color.huecurrent, true)
...
function rocketColorPicker:mouseDown()
...
function rocketColorPicker:mouseUp(button, state)
...
function rocketColorPicker:mouseMove(x,y)
...
function rocketColorPicker:mouseSnap()
  if self.gui.track and source == self.gui.track then
...
function rocketColorPicker:updateColor()
