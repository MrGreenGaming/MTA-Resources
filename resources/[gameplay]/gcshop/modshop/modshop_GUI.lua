...
function translateModshopWidget()
	...
	guiSetText(gui["lblCol1"], _("Paint ${num}:") % {num=1})
	guiSetText(gui["lblCol2"], _("Paint ${num}:") % {num=2})
	...
	guiSetText(gui["labelCurrentVehicle"], _("Currently modding: ${vehicle}") % {vehicle="N/A"})
end
