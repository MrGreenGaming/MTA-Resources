---
-- Help functions for GUI and other stuff
--
-- @author	driver2
...
guiHelp = {}
guiHelpDefaultText = "[Move over GUI to get help]"
guiHelpMemo = nil
...
function handleEditButtonClick()
	for button,doThis in pairs(editButtons) do
		if source == button and isElement(source) then
...
-- Table helpers from race gamemode
