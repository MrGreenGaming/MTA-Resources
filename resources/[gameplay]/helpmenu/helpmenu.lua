...
function buildGUI()
	...
	guiCreateLabel(420, 370, 180, 20, "neox. - Map Assistant", false, AboutTab)
	guiCreateLabel(600, 230, 180, 20, "Jack123 - Admin", false, AboutTab)
	guiCreateLabel(600, 250, 180, 20, "Flipper - Admin", false, AboutTab)
	guiCreateLabel(600, 270, 180, 20, "F1MADKILLER - Admin", false, AboutTab)
	guiCreateLabel(600, 290, 180, 20, "Hulpje - Admin", false, AboutTab)
	guiCreateLabel(600, 310, 180, 20, "Goldberg - Admin", false, AboutTab)
	guiCreateLabel(600, 330, 180, 20, "Besweeet - Admin", false, AboutTab)
