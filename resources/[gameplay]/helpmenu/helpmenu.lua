...
function buildGUI()
	...
	guiCreateLabel(420, 290, 180, 20, "Bob_Taylor - Map manager", false, AboutTab)
	guiCreateLabel(420, 310, 180, 20, "Cena - Map manager", false, AboutTab)
	guiCreateLabel(420, 330, 180, 20, "(O)_(O) - Admin", false, AboutTab)
	guiCreateLabel(420, 350, 180, 20, "warp. - Admin", false, AboutTab)
	guiCreateLabel(420, 370, 180, 20, "Moshpit - Admin", false, AboutTab)
	guiCreateLabel(420, 390, 180, 20, "F1madkiller - Admin", false, AboutTab)
	
	guiCreateLabel(600, 230, 180, 20, "Jack123 - Admin", false, AboutTab)
	guiCreateLabel(600, 250, 180, 20, "Retard - Admin", false, AboutTab)
	guiCreateLabel(600, 270, 180, 20, "neox. - Admin", false, AboutTab)
	guiCreateLabel(600, 290, 180, 20, "Hulpje - Admin", false, AboutTab)
	guiCreateLabel(600, 310, 180, 20, "SkyNet - Admin", false, AboutTab)
	guiCreateLabel(600, 330, 180, 20, "Goldberg - Admin", false, AboutTab)
	guiCreateLabel(600, 350, 180, 20, "Besweeet - Admin", false, AboutTab)
	guiCreateLabel(600, 370, 180, 20, "AleksCore - Admin", false, AboutTab)
