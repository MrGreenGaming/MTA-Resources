...
local snow = {}
-- default settings
settings = {type = "real", density = 50, wind_direction = {0.01,0.01}, wind_speed = 1, snowflake_min_size = 1, snowflake_max_size = 3, fall_speed_min = 1, fall_speed_max = 2, jitter = true}
