if isVoiceEnabled() then
	...
	addEventHandler("onPlayerMute", root, function() setPlayerVoiceMuted(source, true) end)
	addEventHandler("onPlayerUnmute", root, function() setPlayerVoiceMuted(source, false) end)
else
