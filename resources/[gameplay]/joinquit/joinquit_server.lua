    ...
    if errno == 0 then
        ...
        for k,v in ipairs(data) do
            if v.country == country then
                ...
                outputChatBox("#FF6464✶ Country: "..tostring(v.country).." | Cases: "..tostring(v.cases).." | Today Cases: "..tostring(v.todayCases).." | Deaths: "..tostring(v.deaths).." | Recovered: "..tostring(v.recovered), root, 0, 255, 0, true)
            end
        end
    end
end
