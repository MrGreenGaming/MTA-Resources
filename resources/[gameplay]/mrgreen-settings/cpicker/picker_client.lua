...
function colorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "cpicker/sv.png", 0, 0, 0, self.color.white, true)
  dxDrawImage(x+288, y+32, 32, 256, "cpicker/h.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "cpicker/cursor.png", 0, 0, 0, self.color.white, true)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "cpicker/cursor.png", 0, 0, 0, self.color.huecurrent, true)
