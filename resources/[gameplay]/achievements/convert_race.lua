...
local achievementList = {
	...
	["Win 3 times in a row (Min 5 players) - (100 GC)"] = 3,
	["Win 5 times in a row (Min 5 players) - (200 GC)"] = 4,
	["Win 10 times in a row (Min 5 players) - (300 GC)"] = 54,
